...
## 8. Practical Work Done in 02 Folder

For practical understanding, visit:

- Dynamic components: [02_create_react_component/create-first-component/src/Hello.jsx](02_create_react_component/create-first-component/src/Hello.jsx)
- Reusable components: [02_create_react_component/create-first-component/src/Random.jsx](02_create_react_component/create-first-component/src/Random.jsx)
- Integration and rendering flow: [02_create_react_component/create-first-component/src/App.jsx](02_create_react_component/create-first-component/src/App.jsx)
